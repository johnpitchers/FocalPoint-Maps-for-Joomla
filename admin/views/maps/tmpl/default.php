...
if ($saveOrder) {
    ...
    JHtml::_('sortablelist.sortable', 'mapsList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
?>

    <form action="<?php echo JRoute::_('index.php?option=com_focalpoint&view=maps'); ?>" method="post" name="adminForm"
                ...
                <?php else : ?>
                    <table class="table table-striped" id="mapsList">
                        ...
                        <tr>
                            ...
                            <th>
                                <?php echo JHtml::_('searchtools.sort', 'COM_FOCALPOINT_MAPS_TITLE', 'a.title', $listDirn, $listOrder); ?>
                            </th>
                            <th width="10%" class="nowrap hidden-phone">
                                <?php echo JHtml::_('searchtools.sort', 'COM_FOCALPOINT_MAPS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
                            </th>
                            ...
                            <tr class="row<?php echo $i % 2; ?>" sortable-group-id="0">
                                ...
                                <td class="has-context">
                                    <div class="pull-left">
                                        ...
                                        <?php endif; ?>
                                        <?php if ($canEdit) : ?>
                                            <a href="<?php echo JRoute::_('index.php?option=com_focalpoint&task=map.edit&id=' . $item->id); ?>"
