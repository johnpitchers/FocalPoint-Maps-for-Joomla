...
?>
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_focalpoint&view=locationtypes'); ?>" method="post"
                ...
                <?php else : ?>
                    <table class="table table-striped" id="locationTypesList">
                        ...
                        <tr>
                            ...
                            <th>
                                <?php echo JHtml::_('searchtools.sort', 'COM_FOCALPOINT_LOCATIONTYPES_TITLE', 'a.title', $listDirn, $listOrder); ?>
                            </th>
                            <th>
                                <?php echo JHtml::_('searchtools.sort', 'COM_FOCALPOINT_LOCATIONTYPES_LEGEND', 'legend_title', $listDirn, $listOrder); ?>
                            </th>
                            <th width="10%" class="nowrap hidden-phone">
                                <?php echo JHtml::_('searchtools.sort', 'COM_FOCALPOINT_LOCATIONTYPES_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
                            </th>
                        ...
                        <?php foreach ($this->items as $i => $item) :
                            ...
                            <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->legend; ?>">
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        <?php echo JHtml::_('jgrid.published', $item->state, $i, 'locationtypes.', $canChange, 'cb'); ?>
                                    </div>
                                </td>
                                ...
                                <td class="has-context">
                                    <div class="pull-left">
                                        <?php if ($item->checked_out) : ?>
                                            <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'locationtypes.', $canCheckin); ?>
                                        <?php endif; ?>
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo JRoute::_('index.php?option=com_focalpoint&task=locationtype.edit&id=' . $item->id); ?>"
...
<?php // echo"<pre>"; print_r($this->items[0]); echo "</pre>"; echo"<pre>"; print_r($this->state); echo "</pre>";?>