...
class FocalpointTablelocationtype extends JTable
{
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (isset($array['legend'])):
            if (is_array($array['legend'])) {
                $array['legend'] = implode(',', $array['legend']);
            } else if (strrpos($array['legend'], ',') != false) {
                $array['legend'] = explode(',', $array['legend']);
            }
        endif;
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_focalpoint.locationtype.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_focalpoint', 'locationtype');
            $default_actions = JFactory::getACL()->getAssetRules('com_focalpoint.locationtype.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_focalpoint.locationtype.' . (int)$this->$k;
    }
