...
class FocalpointTablelegend extends JTable
{
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_focalpoint.legend.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_focalpoint', 'legend');
            $default_actions = JFactory::getACL()->getAssetRules('com_focalpoint.legend.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_focalpoint.legend.' . (int)$this->$k;
    }
